 ...
 */
function hook_commerce_realex_redirect_subs_payer_ref_alter(&$payer_ref, $account, $order) {
 ...
 */
function hook_commerce_realex_redirect_subs_pmt_ref_alter(&$pmt_ref, $order) {
